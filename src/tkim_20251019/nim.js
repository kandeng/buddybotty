// import { NIM, setAdapters, wxAdapters, V2NIMMessageService, V2NIMMessageLogUtil, V2NIMConversationService, V2NIMConst } from '../../../../dist/esm/nim'
import {
  NIM,
  setAdapters,
  uniAppAdapters,
  ...
  V2NIMSettingService,
  V2NIMConst
} from 'nim-web-sdk-ng/dist/esm/nim.js'

// Export adapters for lazy loading
export { setAdapters, uniAppAdapters }
