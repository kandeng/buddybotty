...
// 使用异步组件导入
const MessageFile = defineAsyncComponent(() => import('../../../../../pages_chat_conversation/NEUIKit/pages/Chat/message/message-file.vue'))
const MessageAudio = defineAsyncComponent(() => import('../../../../../pages_chat_conversation/NEUIKit/pages/Chat/message/message-audio.vue'))
